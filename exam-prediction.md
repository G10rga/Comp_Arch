...
## 1c. ⚡ Wildcard — გამოთვლითი კითხვები (განახლებული შეფასება)

**შენიშვნა:** თავდაპირველად გამოთვლები ქვედა ტიერებში ჩავსვი, რადგან მიდტერმში (თ.4–6) აქცენტი დასახელებულ ტექნოლოგიებსა და შედარებებზე იყო. **მაგრამ ეს არგუმენტი სუსტია გამოთვლებისთვის:** მიდტერმს ალბათ საერთოდ არ ჰქონდა გამოთვლითი კითხვები, ამიტომ „არ ხაზგასმა" ≠ „თავს არიდებს". შენი ლოგიკა — *ეს ახალი მასალაა* — სამართლიანია, პლუს გამოთვლებს **ობიექტური, ერთმნიშვნელოვანი პასუხი** აქვს, რაც წერითი ღია გამოცდისთვის იდეალურია (ადვილი შესაფასებელია).

**ამიტომ ეს ჯგუფი ავწიე — ისწავლე ფორმულები აუცილებლად:**

| თემა | კითხვები | ფორმულა | მაგალითი |
|---|---|---|---|
| **სიმძლავრე → დენი (პროცესორი)** | თ.13 კ.16, კ.17 | I = P / (U × η) | 120 ვტ, 12 ვ, 80% → 120/(12×0.8) = **12.5 ა** |
| **ვიდეოადაპტერი → დენი + გასართი** | თ.13 კ.19, კ.20 | I = P / 12, შემდეგ აარჩიე გასართი ტერმინალის ამპერაჟით | 300 ვტ → 300/12 = **25 ა** → მინ. 3×(+12ვ) → 6-კონტ. PCIe |
| **PCIe გამტარუნარიანობა** | თ.10 კ.20, კ.21 | სიხშირე × ტრასები × ციკლის მონაცემები; **დუპლექსი ×2** | 2500×8×0.8 = 16000 მბიტ/წმ = 2 გბ/წმ → დუპლექსი **4 გბ/წმ** |
| **HDD გადაცემის სიჩქარე** | თ.15 კ.4 | MDTR = SPT × 4096 × RPM / 60 | — |
| **DDR მინ. უჯრედის სიხშირე** | თ.9 კ.31, კ.32, კ.33 | შიდა სალტის სიხშირე (prefetch-ით) | DDR4-3200 → შიდა სალტე **200 მჰც** |

**ტაქტიკა:** ეს ფორმულები 5 წუთში ისწავლება და თუ თუნდაც ერთი გამოთვლითი კითხვა მოვა, გარანტირებული ქულაა. ერთ-ერთი 5 კითხვა შეიძლება სწორედ სიმძლავრის/დენის გამოთვლა იყოს.
...
- **პ:** SMART — Self-Monitoring, Analysis and Reporting Technology — ვინჩესტერის მდგომარეობის შეფასებისა და შეცდომების წინასწარმეტყველების სტანდარტია. დაზიანების ალბათობის გაზრდისას ის BIOS-ს ან სისტემას შეტყობინებას უგზა  ნის.
...
- **პ:** Intel High Definition Audio, იგივე HD Audio / Azalia, არის აპარატურული აუდიოკოდეკების სპეციფიკაცია. AC’97-თან შედარებით გაუმჯობესებულია ციფრული ხმის ხარისხი და გაზრდ  ლია არხების რაოდენობა.
...
- **კ:** ჩამოთვალეთ მუდმივი მეხსიერების მიკროსქემების ტიპები და    ოახდინეთ მათი შედარებითი ანალიზი.
...
- **კ:** ფიზიკურად სად იწერება CMOS Setup და როგორ ხორციელდება მისი კვება კომპიუტერის გამორთულ მდგომარეობაში ყოფნის დრო  ?
...
- **კ:** აღწერეთ USB 3.0 გასართების კო   ტაქტები.
